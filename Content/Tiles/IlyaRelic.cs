...
namespace IlyasWrath.Content.Tiles
{
	public class IlyaRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "IlyasWrath/Content/Tiles/IlyaRelic";

		public override string Texture => "IlyasWrath/Content/Tiles/RelicPedestal";
